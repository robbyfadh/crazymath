<?php
	...
	// maka simpan username dan file dari index.php ke dalam cookie username
...
<body>
	...
	<?php
		...
		if ($_SESSION['lives'] <= 0){
			...
			// bagian kode untuk insert data username, score, playtime, dan foto ke tabel scores
			include 'dbconfig.php';
			$db = mysqli_connect($dbhost, $dbuser, $dbpass, $dbname);
			$query = "INSERT INTO scores (username, scores, playtime, foto) VALUES ('".$_COOKIE['username']."', ".$_SESSION['score'].", '".date('Y-m-d H:i:s')."','".$_COOKIE['foto']."')";
